        ...
        startKnapp.addActionListener(e -> {
            ...
            higher.addActionListener(f -> {
                ...
                if (newGame.guess(true).equals("correct")) {
                    log.append(newGame.getCurrentPlayer().getName() + " - NO DRINK, " + "the number was: " + newGame.getAnswer() + "\n" );
                } else {
                    log.append(newGame.getCurrentPlayer().getName() + " - DRINK, " + "the number was: " + newGame.getAnswer() + "\n" );
                }
